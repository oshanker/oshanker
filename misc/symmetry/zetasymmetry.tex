...
\label{eq:mean}
\end{equation}
Equation \ref{eq:mean} was explicitly called out for Gram points ($\phi = 0$ and $\phi = \pi$) in Ref.~\cite{Titchmarsh 1934}.  Our other two conjectures are that $p_{\phi}(y)$ satisfies the anti-symmetry condition
\begin{equation}
