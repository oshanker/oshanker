...
%\usepackage{amssymb}
% comment out if using  amsart.cls
%\usepackage{amsmath,amsthm,amssymb,verbatim}
...
\date{}
\lhead[]{}
\chead[\underline{xxx}]{\it{AMO - Advanced Modeling and Optimization, Volume 20, Number 2, 2018}}
\rhead[]{}
...
\symbolfootnote[0]{\bf{*AMO - Advanced Modeling and Optimization. ISSN: 1841-4311}}
...
%\clearpage
\chead[\underline{O. Shanker}]{\underline{Symmetry properties of distribution of Riemann Zeta Function}}
