...
In this work we discuss the symmetry properties of the distribution of Riemann zeta values on the critical axis. 
 The study of the symmetry properties  will hopefully give us insight into the theoretical underpinnings of the location of zeros of the Riemann Zeta Function.
The new results presented in this work are:
\begin{enumerate}
\item A mean value relation Equation~\ref{eq:mean},
...
The new and interesting results are stated in three conjectures. 
Our first new conjecture is that the mean value $\langle Z(t_{\phi})\rangle$ is given by
\begin{equation}
\langle Z(t_{\phi})\rangle = 2\cos (\phi).
\label{eq:mean}
\end{equation}
Equation~\ref{eq:mean} was explicitly called out for Gram points ($\phi = 0$ and $\phi = \pi$) in Ref.~\cite{Titchmarsh 1934}.  

The second conjecture is the anti-symmetry condition
\begin{equation}
...
The third conjecture is the symmetry condition
\begin{equation}
...
In this work we defined phi points on the critical axis, in analogy with Gram points. We used this definition to  formulate three new conjectures about the distribution of $Z(t)$ on the critical axis. We stated the mean value condition  Equation \ref{eq:mean}. This is a generalization of Titchmarsh's result~\cite{Titchmarsh 1934}.
We next stated the anti-symmetry condition  Equation \ref{eq:antisym}. This is a generalization of Conjecture 1 in 
Ref.~\cite{Shanker 2018} to phi points.
We stated the symmetry condition  Equation \ref{eq:sym}. 
