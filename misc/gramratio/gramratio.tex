...
In the course of these investigations we observed some remarkable patterns. First, we observed that the 
...
\end{mydef-non}
We discuss these results in Sections \ref{sec6} and \ref{sec7}.
