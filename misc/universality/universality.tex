...
probability densities for several values of $z$ and $\phi$. Table~\ref{tab:coefficients} gives the fitted values 
...
\hline
 \phi    &  \multicolumn{2}{c}  {Median }   &    \multicolumn{2}{c}  {Max.} \\
  \cline{2-5}  
