...
\ref{sec4a} and \ref{sec4b} we will present further statistical properties of zeta values at pairs and triples of consecutive Gram Points. These will help to validate Conjectures  \ref{antisymmetry} and  \ref{symmetry}.
