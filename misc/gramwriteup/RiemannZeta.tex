...
One defines
\begin{equation}
\theta(t) = arg (\pi^{âˆ’it/2} \Gamma(\frac{1}{4} + \frac{it}{2})), 
\label{eq:theta}
\end{equation}
...
Figure~\ref{ZGram} shows the Riemann-Siegal function $Z(g_n)$ . Given the desirable properties of the Gram points, it seems 
...
Reference to Conjecture \ref{symmetry}.
