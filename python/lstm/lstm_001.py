...
print('type(reframed)', type(reframed))
print(reframed.head())
 
# split into train and test sets
values = reframed.values
print('reframed.values', reframed.values.shape)
...
# design network
model = Sequential(name='lstm_001')
model.add(LSTM(50, input_shape=(train_X.shape[1], train_X.shape[2])))

model.add(Dense(1))

print(model.summary())
keras.utils.vis_utils.plot_model(model, to_file='../out/lstm_001.png', show_shapes=True, show_layer_names=True)

loss = ['mae', 'mse']
model.compile(loss=loss[1], optimizer='adam')
# fit network
#epochs=50
epochs=40
verbose=0
